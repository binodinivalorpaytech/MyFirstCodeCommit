...
public class DashboardAPITest {
    ...
    public static void main(String[] args) {
        ...
        // ✅ Extract values
        int transactionCount = response.jsonPath().getInt("data[0].transactionCount");
        int volumeCount = response.jsonPath().getInt("data[0].volumeCount");
